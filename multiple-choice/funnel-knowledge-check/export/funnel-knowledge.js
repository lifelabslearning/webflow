...
<label class="card">
  ...
  <span class="option">
    ...
    <span class="feedback">
      Try again: An obstacle is something that gets in the way of a
      desired goal or state.
    </span>
  </span>
</label>
<label class="card">
  ...
  <span class="option">
    ...
    <span class="feedback">
      Try again: Options are different ways of approaching or solving a
      problem.
    </span>
  </span>
</label>
...
<label class="card">
  ...
  <span class="option">
    ...
    <span class="answer">Success</span>
    <span class="feedback">
      Try again: Success refers to a goal designed to help you identify
      your desired state.
    </span>
  </span>
</label>
<label class="card">
  ...
  <span class="option">
    ...
    <span class="answer">Obstacles</span>
    <span class="feedback">
      Correct! The keyword is concern. A concern is something that gets in
      the way of your desired goal or state.
    </span>
  </span>
</label>
<label class="card">
...
<label class="card">
  ...
  <span class="option">
    ...
    <span class="feedback">
      Correct! The key word is possibilities. Options are different ways
      of approaching or solving a problem.
    </span>
  </span>
</label>
<label class="card">
